<template>
  <div class="article-meta-bar">
    <div class="meta-left-tags">
      ...
      <span class="category-name">{{ category || '✈️ 机场评测' }}</span>
...
const props = defineProps({
  ...
  category: { type: String, default: '✈️ 机场评测' },
...
const { page } = useData()
const { currentViews } = useArticleStats(props.id, props.views || 0, props.likes || 0)
