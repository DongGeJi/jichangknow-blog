...
description: 懂哥机独家 3800 字深度白皮书：iOS 小火箭 (Shadowrocket) 免信用卡注册美区 Apple ID 购买、节点订阅导入、Sub-Store 规则分流、HTTPS 解密与常见报错排错。
category: 🛠️ 软件与教程中心
outline: [2, 3]
aside: true
---
...
<ArticleHeader :likes="348" :views="2180" badge="保姆级教程" badgeClass="badge-top" category="🛠️ 软件与教程中心" date="2026-08-17" id="shadowrocket-ios-guide" tags="Shadowrocket, 小火箭, iOS翻墙, 规则分流, Apple ID"/>
...
<ArticleLikes :initial="348" id="shadowrocket-ios-guide" mode="bottom"/>
