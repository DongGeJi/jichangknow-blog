...
<ArticleHeader :likes="295" :views="1980" badge="硬核部署" badgeClass="badge-top" category="🛠️ 软件与教程中心" date="2026-08-17" id="soft-router-openclash-guide" tags="软路由, OpenWrt, OpenClash, 旁路由, 全屋翻墙, Apple TV"/>
...
<ArticleLikes :initial="295" id="soft-router-openclash-guide" mode="bottom"/>
